...
| Step | Change | Status |
|---|---|---|
| 1 | Remove superseded finder/sort components and their dedicated tests | IN PROGRESS |
| 2 | Remove CSS that is proven unused after Step 1 | NOT STARTED |
...
After Step 1 is verified by CI: Step 2 – remove CSS that is proven unused after the legacy components are gone.
